...
const population = 40;
const football = true;
console.log('Мой город : ' + myTown);
console.log('Моя страна : ' + myCountry);
console.log('Численность населения - ' + population + ' млн. человек');
console.log('Есть ли футбольный стадион - ' + football);
...
console.log('площадь прямоугольника = ' + square + ' см2');
...
let distFirst = time * speedOfFirst;
let distSecond = time * speedOfSecond;
let allDist = distFirst + distSecond;

console.log(allDist + ' км');
