...
console.log('Имя - ' + people.name);
console.log('Фамилия - ' + people.surname);
console.log('Возарст - ' + people.age);
console.log('Eсть ли домашние животные - ' + people.animal);
